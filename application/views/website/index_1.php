 ...
 <!--====================about us section end==================================================== -->
   ...
   <?php if ($menu_p['gallery'] != 0) : ?>
                ...
                <div class="col-md-6"style="border:1px solid #d2d2d2;padding:7.4rem 6rem;">
                    ...
                    <form class="contact_form" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" class="form-control" id="" rows="1"></textarea>
                        </div>
    ...
    <?php if ($menu_p['map'] != 0 && !empty($company)) : ?>
        <div class="container" style="margin:100px; border:5px solid #dddddd;box-shadow: 3px 3px 30px 0px grey;">
